...
export const publish = async (newVersion?: string): Promise<string> => {
    try {
        ...
        tempPackageJson.files = ['dist/authorization/**/*', 'README.md'];
        ...
        // create temporary tsconfig that only includes authorization files
